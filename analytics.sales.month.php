<?php  
    ...
    if($users_role === '1'){
        ...
        require_once 'fetch-data/analytics.current.month.php'; 
                ...
                <div class="content">
                    ...
                    <div class="container-fluid ">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box">
                                    ...
                                    <h4 class="page-title font-weight-bold" style="color: #145388; letter-spacing: 1px;">Sales Analytics : <span class="text-secondary"> This Month </span> </h4>
                                </div>
                            </div>
                        </div>     
                        <!-- end page title --> 
                        ...
                        <div class="card" >
                                    ...
                                    <h4 class="header-title mb-0"> <?php echo date('F') ?>, <span class="text-success"> <?php echo $days_spent." Days" ?></span> So Far</h4>
...
<script type="text/javascript">
    ...
    colors: ["#23b397","#f064b3"],
    series: [
        {
        name: "Sales",
        data: [<?php echo implode( ", ", $month_sale_array ); ?>]
        }
        ,
        {
        name: "Profit",
