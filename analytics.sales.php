<?php  
    ...
    if($users_role === '1'){
        ...
        require_once 'fetch-data/analytics.monthly.php'; 
                    ...
                    <div class="container-fluid ">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box">
                                    ...
                                    <h4 class="page-title font-weight-bold" style="color: #145388; letter-spacing: 1px;">Analytics : <span class="text-secondary"> Sales </span> </h4>
                                </div>
                            </div>
                        </div>     
                        <!-- end page title --> 
                        ...
                        <div class="card" >
                            <div class="card-body">
                                ...
                                <h4 class="header-title mb-0">Sales for the Year - <span class="text-danger"> <?php echo date('Y') ?></span></h4>
...
var options = {
    ...
    series: [
        {
        name: "Sales",
        data: [<?php echo implode( ", ", $monthly_sales_array ); ?>]
        }
        // , 
        // {
        // name: "Profit",
        // data: [<?php echo implode( ", ", $monthly_profit_array ); ?>]
        // }
    ],
    xaxis: {
