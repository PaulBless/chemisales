<?php  
    ...
    if($users_role === '1'){
        ...
        require_once 'fetch-data/analytics.week.php'; 
...
?>
            ...
            <div class="content-page bg-light">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box">
                                    ...
                                    <h4 class="page-title font-weight-bold" style="color: #145388; letter-spacing: 1px;">Sales Analytics : <span class="text-secondary"> This Week </span> </h4>
                                </div>
                            </div>
                        </div>     
                        <!-- end page title --> 
                ...
                ?>
                                    <h4 class="header-title mb-0"> Week Date: <span class="text-secondary"><?php echo $this_week_sd = date("d F, Y", $monday)." to ".$this_week_ed = date("d F, Y",$sunday); ?></span></h4>
...
<script type="text/javascript">
    ...
    colors: ["#1c8238","#23b397"],
    series: [
        {
        name: "Sales",
        data: [<?php echo implode( ", ", $day_sales_array ); ?>]
        } 
        // ,
        // {
        // name: "Profit",
