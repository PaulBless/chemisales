<?php require_once '../../db/db.php'; ?>
                                        ...
                                        $getUserInfo = mysqli_query($connect_db,"SELECT * FROM tbl_users join tbl_account_status on tbl_users.user_status = tbl_account_status.asid join tbl_roles on tbl_users.user_type = tbl_roles.rid ORDER BY `user_date_created` ASC")or die(mysqli_error($connect_db));
