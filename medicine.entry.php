                     ...
                     <div class="card-box">
                        <form action="" method="post" id="add-medicine" >
                            <div class="row">
                                ...
                                <div class="col-md-6">   
                                   ...
                                   <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group mb-3">
                                                <label for="medicineCode">Batch Number:</label>
                                                <input type="text" class="form-control text-dark font-weight-normal" name="batch-number" value="" id="batch-number" placeholder="T-G12345">
                                            </div>
                                        </div>
                                        <div class="col-md-6 d-none">
                                            <div class="form-group mb-3">
                            ...
                            <div class="row d-flex justify-content-center">
                                ...
                                <button class="btn btn-secondary waves-effect" type="button" id="cancel">Cancel </button>
                            </div>
                ...
                $.ajax({
                    ...
                    success: function(res) {
                        ...
                        else if (res === 'exist')
                        {
                            swal.fire(
                                'Duplicate!', 
                                'This medicine is already added or exists.. Kindly Check & Specify Unique Medicine Names', 
                                'error');
                        }
                        else{
                            Swal.fire(
