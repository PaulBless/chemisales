                    ...
                    <div class="page-title-box">
                        <div class="page-title-right">
                            <a href="medicine.entry.php" class="btn btn-pink btn-md waves-effect waves-light float-right">
                                <i class="mdi mdi-pill mr-1"></i> Add New Medicine
                            </a> 
                        </div>
                            <h4 class="page-title font-weight-bold" style="color: #145388; letter-spacing: 1px;"> Manage Medicines </h4>
                    </div>
                </div>
            </div>
            <!-- end page title -->
        ...
        $('#edit_medicine').submit(function(e) {
            ...
            $.ajax({
                ...
                success: function(res) {
                    ...
                    swal.fire('Success!', 'Drug or Medicine details updated successfully!', 'success');
                    getMedicines();
