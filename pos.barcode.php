                    ...
                    <form action="" method="post" name="addform">
                       <div class="row mb-1">
                            <div class="col-lg-12 col-md-12 col-sm-12" >
                                <input type="text" name="barcode" id="barcode" class="form-control text-dark text-center border-dark" placeholder="Scan Item Barcode" onmouseover="" autofocus>
                            </div>  
                        </div>
            ...
            <aside class="col-md-8" id="shopping-cart">
                    ...
                    <input type="hidden" value="<?php  echo $id; ?>" name="user-id" id="user-id" />   
                                ...
                                <div class="row mb-2">
                                    ...
                                    <div class="col-md-4">
                                        <input class="form-control text-center text-purple font-weight-bold border-dark" name="amountPaid" autocomplete="off" id="amountPaid" type="text" min="1" maxLength="8" onkeypress="return isNumberKey(event)" placeholder="Enter Amount Paid"/>
                                    </div>
                                </div>
                               ...
                               <!-- Action Buttons -->
                                <div class="row ">
                                    ...
                                    <div class="col-md-6">
                                        <button type="button" name="pay" id="clear-all" class="btn btn-danger w-100 my-2 font-weight-bold" style="letter-spacing: 1px;"> Clear All </button>
                                    </div> 
                                    <div class="col-md-6">
                                        <button type="submit" name="pay-print" id="1" class="btn btn-success btn-submit w-100 my-2 font-weight-bold" style="letter-spacing: 1px;">  Confirm Pay </button>
                                    </div>
