...
## Query 3 - Get Currency
    ...
    // get printer option
    $sql_printer = mysqli_query($connect_db,"SELECT * FROM `tbl_settings` WHERE `settings_id` = '11'")or die(mysql_error($connect_db));
    $fetch = mysqli_fetch_assoc($sql_printer);
    $get_printer_value = $fetch['settings_ans'];
    
    // get barcode_scanner option
    $sql_barcode = mysqli_query($connect_db,"SELECT * FROM `tbl_settings` WHERE `settings_id` = '12'")or die(mysql_error($connect_db));
                    ...
                    <form action="" method="post" name="addform">
                        ...
                        <div class="row mb-1">
                            <div class="col-lg-12 col-md-12 col-sm-12" style="display: none">
                                <input type="text" name="barcode" id="barcode" class="form-control text-dark text-center border-secondary" placeholder="Scan Item Barcode">
                            </div>  
                        </div>
                    ...
                    <input type="hidden" value="<?php  echo $id; ?>" name="user-id" id="user-id" />   
                               ...
                               <!-- Action Buttons -->
                                <div class="row ">
                                    ...
                                    <div class="col-md-6">
                                        <button type="button" id="clear-all" class="btn btn-danger w-100 my-1 font-weight-bold" style="letter-spacing: 1px;"> <i class="fa fa-times"></i> Clear All </button>
                                    </div> 
                                    
                                    <?php 
                                    if($get_printer_value === '1'){
                                        ?>
                                        <div class="col-md-6">
                                            <button type="submit" name="pay-print" id="2" class="btn btn-primary btn-submit w-100 my-1 font-weight-bold" style="letter-spacing: 1px;" > <i class="mdi mdi-printer"></i> Pay + Print </button>
                                        </div>
                                        <?php
                                    }else{
                                        ?>
                                        <div class="col-md-6 ">
                                            <button type="submit" name="pay" id="1" class="btn btn-success btn-submit w-100 my-1 font-weight-bold" style="letter-spacing: 1px;"> <i class="fe-check-circle"></i> Confirm Pay </button>
                                        </div>
                                        <?php
                                    }
                                    ?>
