...
?>
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box">
                                    ...
                                    <h4 class="page-title font-weight-bold" style="color: #145388; letter-spacing: 1px;">Reports : <span class="text-danger"> Purchases </span> </h4>
                                </div>
                            </div>
                        </div>     
                        <!-- end page title --> 
                        ...
                        <div class="row">
                            <div class="col-12">
                                 <div class="card-box" >
                                    ...
                                    <h4 class="header-title mb-4 text-dark text-center">Purchases Report From :  <span class="text-secondary"><?php echo date('d M, Y',strtotime($get_from)).' to '.date('d M, Y',strtotime($get_to)) ?></span></h4>
    ...
    <div class="details" style="display:none;">
        <div style="text-align: center;">
          ...
          <p><b> Purchase Reports from <?php echo date('d-M-Y', strtotime($get_from)); ?> - <?php echo date('d-M-Y', strtotime($get_to)) ?></b></p>
        </div>
    </div>
