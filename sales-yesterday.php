                    ...
                    <div class="page-title-box">
                        <div class="page-title-right">
                            ...
                            <ol class="breadcrumb m-0 d-none" style="font-size: 11px;">
                                ...
                                <li class="breadcrumb-item active">Sales Yesterday</li>
                            </ol> 
                          
                        </div>
                            <h4 class="page-title font-weight-bold" style="color: #145388; letter-spacing: 1px;">Yesterday's Sales</h4>
                    </div>
                </div>
            </div>
            <!-- end page title -->
                     ...
                     <div class="card-box">
                            ...
                            <table class="table table-bordered table-hover m-0 table-centered nowrap w-100" id="tickets-table">
                                ...
                                <tbody>
                                    <?php
                                        $counter = 1;
                                        $sql_get = "SELECT * FROM `tbl_special_sales` WHERE sales_datetime > DATE_SUB(DATE(NOW()), INTERVAL 1 DAY) ";
                                        $run_query_each_sale = $connect_db->query($sql_get);
                                        if(!empty($run_query_each_sale)){
                                        while($each_sales_row = $run_query_each_sale->fetch_assoc())
                                        {
                                            ...
                                            while($sale_record = $fetch_all_sales->fetch_array())
                                            {
                                                ...
                                                ## ----- Dispaly Records/Details Into Table For Client/User View
                                                ?>
                                                <tr>
