                ...
                <div class="col-12">
                    <div class="page-title-box">
                        ...
                        <a href="sales.yesterday.php">
                            <button type="button" class="btn btn-primary btn-md waves-effect waves-light font-weight-normal float-right ml-2" id="add-staff">
                             <i class="mdi mdi-finance"></i>  Get Yesterday's Sales
                            </button> 
                        </a>
                        
                        <a href="sales.today.php">
                            <button type="button" class="btn btn-warning btn-md waves-effect waves-light font-weight-bold text-dark float-right ml-3" id="get-staff">
                             <i class="mdi mdi-finance"></i>  Get Today's Sales
                            </button>
                        </a>       

                           
                        </div>
                            <h4 class="page-title font-weight-bold" style="color: #145388; letter-spacing: 1px;">All Sales</h4>
                    </div>
                </div>
            </div>
            <!-- end page title -->
                            ...
                            <table class="table table-sm table-bordered table-hover dt-responsive m-0 table-centered nowrap w-100" id="tickets-table">
                                <thead>
                                    <tr style="color: #145388;" class="text-center">
                                        ...
                                        <th class="font-weight-bold">Sales Served By</th>
                                    </tr>
                                </thead>
                                ...
                                <tbody>
                                    <?php
                                        $counter = 1;
                                        $sql_get_each_sale = "SELECT * FROM `tbl_special_sales` ORDER BY `sales_datetime` DESC ";
                                        $run_query_each_sale = $connect_db->query($sql_get_each_sale);
                                        while($each_sales_row = $run_query_each_sale->fetch_assoc())
                                        {
