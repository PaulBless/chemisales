                ...
                <div class="content">
                    ...
                    <div class="container-fluid">
                                ...
                                <div class="row">
                                            <div class="col-lg-6 col-md-6 col-sm-12">
                                                    <div class="form-group mb-3">
                                                        <label for="txt_system_name">Pharmacy Name</label>
                                            ...
                                            <div class="form-group mb-3">
                                                ...
                                                <input type="text" autocomplete="off" id="txt_system_title" value="<?php echo $system_title; ?>" name="txt_system_title" class="form-control" value="Pharmacy Management & Billing System" readonly required>
                                            </div>    
                                     </div> <!-- end col -->
                        ...
                        <div>
                            ...
                            <button class="btn btn-danger btn-md" onclick="return window.location.href='admin.dashboard.php'"> <i class="mdi mdi-close" ></i> Cancel</button>
                        </div>
