                        ...
                        <form id="products_form" method="post">
                            <table class="table table-hover table-striped m-0 table-centered dt-responsive nowrap w-100 rowfy">
                                <thead class="thead-light text-dark">
                                    <tr>
                                        <th width="35%"><div data-toggle="tooltip" data-placement="top" title="Name of Drug ">Drug Name</th>
                                        <th width="12%"><div data-toggle="tooltip" data-placement="bottom" title="Cost Price">Cost <?php echo $currency; ?></div> </th>
                                        <th width="12%"><div data-toggle="tooltip" data-placement="bottom" title="Selling Price "> Price <?php echo $currency; ?></div></th>
                                        <th width="11%"><div data-toggle="tooltip" data-placement="bottom" title="Qty Left">Avail</div></th>
                                        <th width="12%"><div data-toggle="tooltip" data-placement="bottom" title="Quantity">Quantity</div></th>
                                        <th></th>
                                    </tr>
                                </thead>
                                ...
                                <tbody id="table_body">
                                    ...
                                    <tr>
                                        <td>
                                            <select class="form-control medicine-name select-custom " name="medicine[]" id="medicine">
    ...
    $(document).ready(function(){
       const price_value = 0;  // store each unit price of medicine in variable 
        ...
        $(document).on('click', '#add', function(){
            ...
            html += '<tr>';
            html +=
                '<td> <select class="form-control medicine-name select-custom" name="medicine[]" id="medicine"> <option disabled selected>Select Drug Name </option><?php foreach ($products_array as $key => $value) {  ?><option value="<?php echo $key; ?>"><?php echo $value;  ?></option> <?php  }  ?></select> </td>'
            html +=
                '<td><input type="text"  autocomplete="off" onkeypress="return isNumberKey(event)" class="form-control products" name="cost_price[]" required></td>';
            html +=
                '<td><input type="text" autocomplete="off" onkeypress="return isNumberKey(event)"  class="form-control products" name="selling_price" required></td>';
            html +=
...
function addDrug(productName,unitPrice,quantity,total,product_id,supplier){
    ...
    count + '" class="form-control Total form-control-sm available " autocomplete="off" value="'+total+'"></td>';
