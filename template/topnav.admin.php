...
require_once 'db/db.php';
    ...
    $minimum_expire = $get_minimum_item['settings_ans'];  
    ...
    // $getProductInfo = mysqli_query($connect_db,"SELECT * FROM `tbl_medicines` WHERE medicine_expiry_date <= curdate() ORDER BY `tbl_medicines`.`mid` ASC")or die(mysqli_error($connect_db));
    ...
    ?>
    <?php
        // if ($months_remaining <= $minimum_expire && $remaining_days < 0) {
        if ($remaining_days <= $minimum_expire || $remaining_days < 0 ) {
            $expired_counter++;
            array_push($expired_medicine_expiry,$get_expiry);
            array_push($expired_medicine_name,$get_product_name);

        // }else if($months_remaining <= $minimum_expire && $remaining_days > 0){
        }else if($months_remaining = $minimum_expire && $remaining_days > 0){
    ...
    $get_minimum = mysqli_fetch_array($get_minimum_stock_alert);
    $minimum = $get_minimum['settings_ans'];

    // get medicines stock levels 
...
<!-- Topbar Start -->
 <div class="navbar-custom">
            ...
            <li class="d-none d-sm-block">
                ...
                <li class="dropdown notification-list">
                    <a class="nav-link dropdown-toggle  " data-toggle="dropdown" href="#" role="button"
                        ...
                        <span
                            class="badge badge-success rounded-circle noti-icon-badge"><?php echo $stock_alert_counter  ?>
                        </span>
                    </a>
                        ...
                        <div class="slimscroll noti-scroll">
                            ...
                            <a href="javascript:void(0);" class="dropdown-item notify-item"> 
                                ...
                                <p class="text-muted mb-0 user-msg">
                                    <small class="text-success"> <?php echo $current_stock_remain; ?> items remaining</small>
                                </p>
                            </a> 
                ...
                <li class="dropdown notification-list"> 
                    ...
                    <div class="dropdown-menu dropdown-menu-right dropdown-lg">
                        ...
                        <div class="slimscroll noti-scroll">
                            ...
                            <a href="javascript:void(0);" class="dropdown-item notify-item">
                                <div class="notify-icon">
                                    <img src="assets/images/pharmsolv-logo-sm-light.png" height="28" class="img-fluid rounded-circle" alt="" /> 
                                </div>
            ...
            <!-- LOGO -->
            <div class="logo-box">
                <a href="admin.dashboard.php" class="logo text-center">
                    <span class="logo-lg">
            ...
            <ul class="list-unstyled topnav-menu topnav-menu-left m-0">
                ...
                <li class="dropdown d-none d-lg-block">
                    <a class="nav-link dropdown-toggle  text-dark font-weight-normal"  href="pos.php"> POS 
                    </a>
                </li>
                
                
                <li class="dropdown d-none d-lg-block">
                    <a class="nav-link dropdown-toggle  font-weight-light" data-toggle="dropdown" href="#" role="button" aria-haspopup="false" aria-expanded="false"> Alerts <i class="mdi mdi-chevron-down"></i> 
                    </a>
                ...
                <li class="dropdown d-none d-lg-block">
                    ...
                    <div class="dropdown-menu">
                            ...
                            <a href="stats.medicines.php" class="dropdown-item" id="statistics-sales">
                               <i class="mdi mdi-pills"></i> Medicines
                            </a>
                            <!-- item-->
                ...
                <li class="dropdown d-none d-lg-block">
                    <a class="nav-link dropdown-toggle  font-weight-light"  href="sales.receipts.php"> Receipts
                    </a>
                </li>
