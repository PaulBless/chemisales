            ...
            <div class="content-page bg-light">
                <div class="content">
                    ...
                    <div class="container-fluid ">
                        ...
                        <div class="row mt-2" >
                            <div class="col-md-12" >
                                <div class="card" style="border: 1px solid #979797;">
                                    <div class="card-body">
                                            ...
                                            <div class="col-auto mr-1">
                                                    <div class="input-group mb-0">
                                                        <div class="input-group-prepend">
                                                            <div class="input-group-text text-dark font-weight-bold">Select Month:</div>
                                                        </div>
                                                        <input type="date" class="form-control datepicker" id="start-date" name="start-date" placeholder="Start Date" data-date-autoclose="true" autocomplete="off">
                                                        <input class="form-control" id="example-month" type="month" name="month">
                                                        <!-- <select name="
                                                        month-type" id="month-type" class="month-type"></select> -->
                                                    </div>
                                                </div> 
