                ...
                <div class="col-12">
                    <div class="page-title-box">
                        <div class="page-title-right">
                            ...
                            <h4 class="page-title font-weight-bold" style="color: #145388; letter-spacing: 1px;">User Roles</h4>
                    </div>
                </div>
            </div>
            <!-- end page title -->
                ...
                <div class="col-12">
                     <div class="card-box" >
                            ...
                            <table class="table m-0 table-centered dt-responsive nowrap w-100" id="tickets-table">
                                ...
                                <tbody>
                                    <?php
                                        $sql = "SELECT * FROM `tbl_roles` ORDER BY `rid` ASC";
